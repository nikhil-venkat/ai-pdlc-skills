---
name: build
description: Implement the next feature slice against its spec. Use when building or modifying user-facing interfaces — production-quality, accessible, one slice at a time, treating spec.md + research.md as ground truth.
---
